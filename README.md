...
This action installs a pinned version of **autoflake** and all its dependencies,         making sure that file hashes match. Pinning your dependencies:
...
```yaml
      - name: Install autoflake from PyPI
        uses: install-pinned/autoflake@d4d21433c0eafd929f981c2cc96c2eb3f76de31b  # 2.0.1
```
